<?php 
   ...
   if(isset($_POST['signin'])){
       ...
       $sql = "SELECT * FROM ngo WHERE Username = '$username' OR Password = '$password'";
       ...
       if($row == 1){
         ...
         echo '<script>
                 ...
                 window.location.href = "ngologin.php";
                 </script>';
       }
     }
?>
...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <div class="cont">
        <div class="car">
          <div class="car_title">
            <h1>Sign In</h1>
            <span>Don't Have An Account? <a href="../Signup/ngosignup.php">Sign Up</a></span>
          </div>
          <div class="formm">
