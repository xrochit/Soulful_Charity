...
<body>
    ...
    <section class="dashboard">
        <div class="top">
            ...
            ?>
                <img src="../Dashboard/Images/logo.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title"><?php echo "Welcome ". $result['Username']; ?></h5>
                    <p class="card-text">If you want to Update your profile please click below.</p>
