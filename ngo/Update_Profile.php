...
if(isset($_POST['update_profile'])){
   ...
   mysqli_query($conn, "UPDATE `ngo` SET Username = '$update_name', Email = '$update_email' WHERE Id = '$user_id'") or die('query failed');
   ...
   if(!empty($new_pass) || !empty($confirm_pass)){
      if($new_pass != $confirm_pass){
         ...
         mysqli_query($conn, "UPDATE `ngologin` SET Password = '$confirm_pass' WHERE Id = '$user_id'") or die('query failed');
