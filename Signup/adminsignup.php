...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <div class="login-page">
        <div class="form">
            <form class="login-form " action="adminsignup.php" method="POST">
                <h2>CREATE A NEW ACCOUNT</h2>
                <input type="text" required placeholder="Name" id="user" name="username" autocomplete="off" />
                <input type="email" required placeholder="E-mail" id="email" name="email" autocomplete="off" />
                <input oninput="return formvalid()" type="password" required placeholder="Create Password" name="password" id="pass" autocomplete="off" />
                <img src="https://cdn2.iconfinder.com/data/icons/basic-ui-interface-v-2/32/hide-512.png"
                    onclick="show()" id="showimg">
                <span id="vaild-pass"></span>
                <button type="submit" name="SignUp">SIGN Up</button>
                <p class="message"><a href="../Login/adminlogin.php">Just Sign In</a></p>
            </form>
        </div>
    </div>
    <script>
